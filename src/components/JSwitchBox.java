...
public class JSwitchBox extends AbstractButton {
    private Color sliderActiveBackground = new Color(132, 199, 193);
    private Color sliderBackground = new Color(129, 129, 129);
    private Color sliderActiveCircle = new Color(38, 166, 154);
    private Color sliderCircle = new Color(241, 241, 241);
    private Color sliderDisabledCircle = new Color(189, 189, 189);
    ...
    public JSwitchBox(String trueLabel, String falseLabel) {
        ...
        double falseLength = getFontMetrics( getFont() ).getStringBounds( falseLabel, getGraphics() ).getWidth();
    ...
    public void setSelected( boolean b ) {
        if(b){
            ...
            setBackground( sliderActiveBackground );
            setText( falseLabel );
        }
        super.setSelected( b );
    }
